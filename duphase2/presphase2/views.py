...
def home(request):
    ...
    data2.append((7,6,'2appia1','appia3d.svg',0.05,0,'Le plot Appia','#ff8d2a','modal ', '2appia1.html'))
    data2.append((7,7,'2worker1','people_worker2.svg',0.075,0,'Les ouvrier du chantier','#ff8d2a','modal ', '2worker1.html'))
    data2.append((2,9,'2man1','people_woman3.svg',0.05,0,'Les pietons, cycliste, ...','#ff8d2a','modal ', '2man1.html'))
    data2.append((9,6,'2dust1','dust.svg',0.1,0,'Les facteurs environnementaux','#ff8d2a','modal ', '2dust1.html'))
    
    data3.append((0,9,'3store1','store2.svg',0.3,0,'Commerces environnants','#ff8d2a','modal ', 'test1.html'))
    data3.append((5,2,'3conect1','conect3d.svg',0.08,0,'CoNect','#63cdff','left sidebar very wide ', 'test1.html'))
    data3.append((4,5,'3noise1','people_worker1.svg',0.1,0,'Les facteurs environnementaux','#556233','right sidebar very wide ', 'test1.html'))
    data3.append((6,5,'3nworker1','barriere_right.svg',1,0,'Les entreprises de travaux publics','#556233','right sidebar very wide ', 'test1.html'))
    data3.append((3,11,'3man1','people_woman2.svg',0.3,0,'Les passants','#ff8d2a','modal ', 'test1.html'))
